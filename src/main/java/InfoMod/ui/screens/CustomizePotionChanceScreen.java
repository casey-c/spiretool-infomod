...
import InfoMod.ui.buttons.ButtonFactory;
import InfoMod.ui.buttons.SimpleButtonWidget;
import InfoMod.ui.buttons.SimpleCheckboxWidget;
import InfoMod.ui.labels.SimpleToolTipWidget;
...
public class CustomizePotionChanceScreen extends MediumLabeledScreen {
    ...
    public CustomizePotionChanceScreen() {
        ...
        mainTextArea = new EditableTextLong(
                ...
                editableText -> {
                    Config.setString(Config.ConfigOptions.POTION_TEXT, editableText.getText());
                }
        );
